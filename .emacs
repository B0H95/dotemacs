...
(defun b0h-scroll-up-command ()
  (interactive)
  (scroll-down-command (/ (window-body-height) 3)))
(defun b0h-scroll-down-command ()
  (interactive)
  (scroll-up-command (/ (window-body-height) 3)))
(defun b0h-scroll-other-window ()
  (interactive)
  (scroll-other-window (/ (window-body-height (other-window-for-scrolling)) 3)))
(defun b0h-scroll-other-window-down ()
  (interactive)
  (scroll-other-window-down (/ (window-body-height (other-window-for-scrolling)) 3)))
(global-set-key (kbd "C-v") 'b0h-scroll-down-command)
(global-set-key (kbd "M-v") 'b0h-scroll-up-command)
(global-set-key (kbd "C-M-v") 'b0h-scroll-other-window)
(global-set-key (kbd "C-M-S-v") 'b0h-scroll-other-window-down)
...
(when (version<= "30.1" emacs-version)
  ...
  (define-key completion-preview-active-mode-map (kbd "M-i") 'completion-preview-complete)

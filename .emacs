...
(defun b0h-completion-in-region-pick-first ()
  ...
  (when (not (minibuffer-window-active-p (frame-selected-window)))
    ...
    (with-minibuffer-completions-window
      (first-completion)
      (choose-completion))))
(define-key completion-in-region-mode-map (kbd "M-SPC") 'b0h-completion-in-region-pick-first)
...
(define-key completion-in-region-mode-map (kbd "M-i") 'minibuffer-choose-completion)

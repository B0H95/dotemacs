...
(eval-after-load "org" '(define-key org-mode-map (kbd "C-M-t") 'b0h-clear-highlight))
...
(eval-after-load "bat-mode" '(define-key bat-mode-map (kbd "C-o") (lambda () (interactive) (b0h-newline-before nil))))
(eval-after-load "bat-mode" '(define-key bat-mode-map (kbd "C-j") (lambda () (interactive) (b0h-newline-after nil))))
...
(eval-after-load "em-hist"
  '(when (version<= "29.1" emacs-version)
     (define-key eshell-hist-mode-map (kbd "M-r") 'b0h-eshell-previous-matching-input)))
...
(eval-after-load "prog-mode"
  '(when (version<= "30.1" emacs-version)
     (define-key prog-mode-map (kbd "C-x C-d") 'prog-fill-reindent-defun)
     (define-key prog-mode-map (kbd "M-q") 'b0h-mark-sexp)
     (define-key prog-mode-map (kbd "M-Q") 'b0h-mark-sexp-revert)))
...
(fringe-mode '(4 . 4))
(eval-after-load "shell" '(define-key shell-mode-map (kbd "M-?") nil))
...
(defun b0h-completion-in-region-pick-first ()
  (interactive)
...
(global-set-key (kbd "M-i") 'b0h-completion-in-region-pick-first)
(setq custom-file (locate-user-emacs-file "custom.el"))
(load custom-file t)
(require 'package)
(add-to-list 'package-archives '("melpa" . "https://melpa.org/packages/") t)
(package-initialize)
;; see https://protesilaos.com/codelog/2024-11-28-basic-emacs-configuration/

...
(set-face-attribute 'mode-line-inactive nil :background b0h-theme-mode-line-inactive-color)
(set-face-attribute 'mode-line-active nil :background b0h-theme-mode-line-active-color)
